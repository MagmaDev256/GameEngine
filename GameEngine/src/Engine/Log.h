...
#define ENGINE_CORE_CRITICAL(...) ::GameEngine::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
#define ENGINE_CRITICAL(...) ::GameEngine::Log::GetClientLogger()->critical(__VA_ARGS__)